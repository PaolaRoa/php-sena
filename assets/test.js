function TABLE_VEHICLE_DETAIL_GetValue() {
    ...
    forEachInArray(chargesArr, function (charge) {
        ...
        //auxiliar function to get TowCars list
        function getTowcars(currentObj, liqdAt) {
            var towCars = [];
        ...
        if (chCode == "OCEFGT-INC") {
            ...
            if (liqdAt != "" && hasValue(liqdAt)) {
                forEach(liqAtItems, function (item) {
                    ...
                    if (tipo == "0") {
                        ...
                        var towCars = "hola container";
                        containers.push(towCars);
            ...
            // 2) RESULT + containers
            var uniContainers = containers.uniques().join("");
        ...
        var uniTowCars = getTowcars(currentObj, liqdAt);
